...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings']], function () {
            ...
            Route::get('send-sms', 'BusinessSettingsController@sendSms')->name('send-sms');
            Route::post('do-send-sms', 'BusinessSettingsController@doSendSms')->name('do-send-sms');
        ...
        Route::group(['prefix' => 'users', 'as' => 'users.'], function () {
            ...
            Route::get('customer/select-list', 'CustomerController@get_customers')->name('customer.select-list');
                  Route::get('vendor/select-list', 'CustomerController@get_vendors')->name('vendor.select-list');
