    ...
    <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered  ">
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <li class="navbar-vertical-aside-has-menu  @yield('send_sms')">
                    <a class="nav-link " href="{{ route('admin.business-settings.send-sms') }}"
                        title="{{ translate('messages.Send_Sms') }} ">
                        <span class="tio-snooze-notification  nav-icon"></span>
                        <span class="text-truncate">{{ translate('messages.Send_Sms') }}
                        </span>
                    </a>
                </li>
