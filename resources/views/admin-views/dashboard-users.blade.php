                    ...
                    <div class="d-flex align-items-center">
                        ...
                        @if(auth('admin')->user()->role_id == 1)
                            <div class="w-0 flex-grow px-3">
                                <h1 class="page-header-title mb-2">{{ translate('messages.User Overview') }}</h1>
                        ...
                        @else
                            <div class="w-0 flex-grow px-3">
                                ...
                                <p class="page-header-text m-0">{{translate('Hello, ')}} {{ auth('admin')->user()->f_name }} {{translate('You Can Manage Your Users')}} {{translate('in')}} : {{ \App\Models\Zone::where('id', $params['user_zone'])->first()?->name }}</p>
                            </div>
                        @endif
